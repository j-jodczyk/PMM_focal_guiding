...
def main():
    # take image
    file_path = "../scenes/modern-hall/Reference.png"
    # take gmm
    # GMM = [
    ...
    # GMM[weight = 1 mean = [-3.68165 2.83468 -0.329687] covaraince = [[17.402 -4.05882 -4.05874][-4.05882 9.16499 -0.290645][-4.05874 -0.290645 5.99207]]
    GMM = [
        { "weight": 1, "mean": [-3.68165, 2.83468, -0.329687], "covaraince": [[17.402, -4.05882, -4.05874], [-4.05882, 9.16499, -0.290645], [-4.05874, -0.290645, 5.99207]] }
    ]

    # AABB = { "min" : [-6.3658, -1.5274, -4.73046], "max" : [5.27597, 8.04131, 10.0598] } # dining room
    AABB = { "min" : [-21.7494, -3.70393, -3.09172], "max" : [7.19249, 11.2965, 6.96201] } # modern hall
    # appy gmm on image
